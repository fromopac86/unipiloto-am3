...
*/
exports.page = function(title, nabvar, content){		//estrcutra del template con 3 elementons
	...
	*/
	...
	.replace('{title}', title, 'g')		//remplaza de manera global
...
*/
exports.loadParameters = function(req, res, next){			//especifico de node js, exporto."parametro"  hacer visible el metodo en todo lado, carga elementos 
